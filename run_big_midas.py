...
def run(dataset, option):
    ...
    if option.depthNet == 0:
        midas_model_path = "midas/dpt_large-midas-2f21e586.pt"
        global midasmodel
...
def estimatemidas(img, net_size=384, resize_mode = "minimal", normalization = NormalizeImage(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5])):
